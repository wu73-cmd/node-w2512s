...
const UUID = process.env.UUID || '4357fd79-839f-49de-b27b-b28108b19278'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'sight';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'hugws';                    // 节点名称
